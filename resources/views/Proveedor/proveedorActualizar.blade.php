              ...
              <div class="card-body">   
                <form method="post" action="{{ route('actualizarProveedor', $Proveedor->id_proveedor) }}" enctype="multipart/form-data" onsubmit="mostrarLoader()">
                  ...
                  <div class="row mb-5">
                    <div class="col-md-4">
                      <div class="input-form">
                        <input type="text" id="nombre" name="nombreProveedor" required value="{{ $Proveedor->nombre_empresarial }}" >
                        <label for="nombre" class="textUser fixed-label">Nombre del proveedor</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-form">
                          <input type="tel" id="telefono" name="numeroTelefono" required value="{{ $Proveedor->telefono }}" >
                          <label for="telefono" class="textUser fixed-label">Telefono del proveedor</label>
                        </div>                          
                      </div>
                      <div class="col-md-4">
                        <div class="input-form">
                          <input type="text" id="contacto" name="nombreContacto" required value="{{ $Proveedor->contacto }}" >
                  ...
                  <div class="row mb-5">
                    ...
                    <input id="url" class="footer" type="text" placeholder="Coloca una URL" name="imagen_url" value="{{ $Proveedor->logo }}" >
                </div>
