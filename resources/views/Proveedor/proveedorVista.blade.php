                  ...
                  <div class="row mb-5">
                    <div class="col-md-4">
                      <div class="input-form">
                        <input type="text" id="nombre" name="nombreProveedor" required value="{{ $Proveedor->nombre_empresarial }}" disabled>
                        <label for="nombre" class="textUser fixed-label">Nombre del proveedor</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-form">
                          <input type="tel" id="telefono" name="numeroTelefono" required value="{{ $Proveedor->telefono }}" disabled>
                          <label for="telefono" class="textUser fixed-label">Telefono del proveedor</label>
                        </div>                          
                      </div>
                      <div class="col-md-4">
                        <div class="input-form">
                          <input type="text" id="contacto" name="nombreContacto" required value="{{ $Proveedor->contacto }}" disabled>
                          <label for="contacto" class="textUser fixed-label">Nombre del contacto</label>
                        </div>
                      </div>
                  </div>
                  <div class="row mb-5">
                    ...
                    <input id="url" class="footer" type="text" placeholder="Coloca una URL" name="imagen_url" value="{{ $Proveedor->logo }}" disabled>
                </div>
                    ...
                    $('#url').on('input', function() {
                        ...
                        <div class="col-md-6">
                            <div class="input-form" style="height: 70%;">
                                <input type="text" id="direccion" name="direccion" required value="{{ $Proveedor->direccion }}" disabled>
                                <label for="direccion" class="textUser fixed-label">Direccion del proveedor</label>
                            </div>
                        </div>
                  </div>
              </div>
