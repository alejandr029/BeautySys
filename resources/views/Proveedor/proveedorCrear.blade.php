                  ...
                  <div class="row mb-5">
                    <div class="col-md-4">
                      <div class="input-form">
                        <input type="text" id="nombre" name="nombreProveedor" required  >
                        <label for="nombre" class="textUser fixed-label">Nombre del proveedor</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-form">
                          <input type="text" id="telefono" name="numeroTelefono" required  >
                          <label for="telefono" class="textUser fixed-label">Telefono del proveedor</label>
                        </div>                          
                      </div>
                      <div class="col-md-4">
                        <div class="input-form">
                          <input type="text" id="contacto" name="nombreContacto" required  >
