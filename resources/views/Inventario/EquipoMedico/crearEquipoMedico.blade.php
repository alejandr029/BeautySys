          ...
          <div class="col-lg-11">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Crear equipo medico</h4>
              </div>
              <div class="card-body">
                <form action="{{ route('Inventario.crear') }}" method="post" enctype="multipart/form-data" onsubmit="mostrarLoader()">
                    @csrf
                  <div class="row mb-5">
                    <div class="col-md-4">
                        ...
                        <div class="input-form">
                            <select id="estatus" name="id_estatus_equipo" required >
                                ...
                                @foreach ($estatus as $item)
                                    <option value="{{ $item->id_estatus_equipo }}">
                                        {{ $item->nombre }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <script>
                        ...
                        <div class="col-md-4">
                          <div class="checkbox-wrapper-31">
                            <input type="checkbox" name=devolucion>
                  ...
                  <div class="text-center mt-3">
                    <button type="submit" class="btn btn-primary">Crear Equipo Medico</button>
              </div>
            </form>
              </div>
            </div>
