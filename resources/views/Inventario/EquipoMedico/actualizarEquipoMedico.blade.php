              ...
              <div class="card-body">
                <form method="post" action="{{ route('Inventario.updateEquipo', $equipoMedico->id_equipo_medico) }}" enctype="multipart/form-data">
                  ...
                  <div class="row mb-5">
                    <div class="col-md-4">
                      <div class="input-form">
                        <input type="text" id="nombre" name="nombre" required value="{{ $equipoMedico->nombre }}">
                        <label for="nombre" class="textUser">Nombre</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="input-form">
                        <input type="text" id="modelo" name="modelo" required value="{{ $equipoMedico->modelo }}" >
                        <label for="nombre" class="textUser ">Modelo</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="input-form">
                        <input type="text" id="marca" name="marca" required value="{{ $equipoMedico->marca }}" >
                        <label for="nombre" class="textUser">marca</label>
                      </div>
                    </div>
                  </div>
                  <div class="row mb-5">
                    <div class="col-md-4">
                      <div class="input-form">
                        <input type="number" id="cantidad" name="cantidad" required value="{{ $equipoMedico->cantidad }}" >
                        <label for="cantidad" class="textUser">Cantidad de equipo medico</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-form">
                            <select id="estatus" name="id_estatus_equipo" required >
                            ...
                            <label for="estatus" class="textUser" style="visibility: hidden">Estatus de equipo medico</label>
                        </div>
                    </div>
                      <div class="col-md-4">
                        <div class="input-form">
                  ...
                  <div class="row mb-5">
                    ...
                    <input id="url" class="footer" type="text" placeholder="Coloca una URL" name="imagen_url" value="{{ $equipoMedico->imagen }}" >
                </div>
                ...
                <script>
                    ...
                    $('#url').on('input', function() {
                        ...
                        <div class="col-md-4">
                            ...
                            <textarea id="descripcion" name="descripcion" required >{{ $equipoMedico->descripcion }}</textarea>
                            <label for="descripcion" class="textUser">Descripción</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                          <div class="checkbox-wrapper-31">
                            <input {{$equipoMedico->devolucion == 1 ? 'checked' : ''}} type="checkbox" name=devolucion>
                  ...
                  <div class="text-center mt-3">
                    <button type="submit" class="btn btn-primary">Actualizar Equipo Medico</button>
              </div>
            </form>
              </div>
            </div>
