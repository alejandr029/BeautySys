                      ...
                      <div class="col-md-4">
                        <div class="input-form">
                          <select id="cirugia" name="cirugia" required>
                            <option value="" disabled selected>Seleccionar Tipo de cirugia</option>
                      ...
                      <div class="col-md-4">
                        <div class="input-form">
                          <select id="estatusCirugia" name="estatusCirugia" required>
                            <option value="" disabled selected>Seleccionar Estatus de cirugia</option>
                      ...
                      <div class="col-md-4">
                        <div class="input-form">
                          <select id="sala" name="sala" required>
                            <option value="" disabled selected>Seleccionar sala a usar</option>
