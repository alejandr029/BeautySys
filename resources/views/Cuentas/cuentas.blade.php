                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-actions">
                                            <div role="group">
                                                <button type="button" class="btn btn-info" style="margin:0rem 0.5rem 0.5rem 0rem; flex:none;" onclick="window.location.href='{{ route('Cuentas.visualizar', $user->id ) }}'; mostrarLoader();">
            ...
            <div class="my-custom-paginator" style="display: flex; justify-content: flex-end; margin-right: 25px;">
                ...
                <ul class="pagination">
                    <li class="page-item {{ $users->currentPage() === 1 ? 'disabled' : '' }}">
                        <a class="page-link" href="{{ $users->url(1) }}" aria-label="First" onclick="mostrarLoader()">
                    ...
                    <li class="page-item {{ $users->previousPageUrl() ? '' : 'disabled' }}">
                        <a class="page-link" href="{{ $users->previousPageUrl() }}" aria-label="Previous" onclick="mostrarLoader()">
                    ...
                    <li class="page-item {{ $users->nextPageUrl() ? '' : 'disabled' }}">
                        <a class="page-link" href="{{ $users->nextPageUrl() }}" aria-label="Next" onclick="mostrarLoader()">
                    ...
                    <li class="page-item {{ $users->currentPage() === $users->lastPage() ? 'disabled' : '' }}">
                        <a class="page-link" href="{{ $users->url($users->lastPage()) }}" aria-label="Last" onclick="mostrarLoader()">
